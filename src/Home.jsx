...
//   ${
//     isScrolled
//       ? "bg-white/95 backdrop-blur-md shadow-lg after:content-[''] after:block after:h-[2px] after:bg-gradient-to-r after:from-blue-600 after:to-purple-600 after:absolute after:bottom-0 after:left-0 after:right-0"
//       : "bg-transparent"
//   }`}
//     >
...
//               className="bg-blue-600 text-white px-6 py-2 font-semibold rounded-full hover:bg-blue-700 transition-colors"
//             >
//               Dashboard
//             </NavLink>
//           </div>
...
//                 <button className="w-full bg-blue-600 text-white py-2 font-semibold rounded-full hover:bg-blue-700 transition-colors">
//                   Dashboard
//                 </button>
//               </NavLink>
//             </div>
...
//       role: "Mother of 2",
//       content:
//         "FenceTrack gave me the peace of mind I needed. I always know where my children are, and the geofence alerts help me ensure they're safe.",
//       rating: 5,
//       avatar: "👩‍💼",
//     },
//     {
...
//       role: "Business Owner",
//       content:
//         "We use FenceTrack for our delivery fleet. The real-time tracking and geofencing features have improved our efficiency dramatically.",
//       rating: 5,
//       avatar: "👨‍💼",
//     },
//     {
...
//               <button
//                 type="submit"
//                 className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-lg font-bold text-lg hover:shadow-lg transition-all duration-300 cursor-pointer flex items-center justify-center space-x-2"
//               >
...
const Navigation = () => {
  ...
  return (
    <nav
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "bg-white/10 backdrop-blur-md shadow-lg after:content-[''] after:block after:h-[2px] after:bg-gradient-to-r after:from-blue-500 after:to-purple-600 after:absolute after:bottom-0 after:left-0 after:right-0"
          : "bg-transparent"
      }`}
    >
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <button className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-2 font-semibold rounded-full hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              Dashboard
            </button>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 py-4 bg-white/10 backdrop-blur-md rounded-lg border border-white/20">
            ...
            <div className="px-4 pt-2">
              <button className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-2 font-semibold rounded-full hover:shadow-lg transition-all">
                Dashboard
              </button>
            </div>
          </div>
...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900">
      <div className="absolute inset-0">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
        ...
        >
          <div className="flex items-center justify-center h-full text-white text-center px-4">
            <div className="max-w-5xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <button className="group bg-white text-gray-800 px-8 py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition-all duration-300 flex items-center space-x-2 transform hover:scale-105 cursor-pointer shadow-lg">
                  <span>Start Tracking Now</span>
                  <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
                </button>
                <button className="group border-2 border-white text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-white hover:text-gray-800 transition-all duration-300 flex items-center space-x-2 cursor-pointer">
  ...
  const features = [
    {
      icon: <MapPin className="w-8 h-8" />,
      title: "Real-Time Location Tracking",
      description: "Get precise GPS coordinates updated every few seconds with battery-efficient technology.",
      color: "from-blue-500 to-blue-600",
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: "Smart Geo-Fencing",
      description: "Create virtual boundaries and receive instant alerts when devices enter or exit safe zones.",
      color: "from-green-500 to-green-600",
    },
    {
      icon: <AlertTriangle className="w-8 h-8" />,
      title: "Emergency Alerts",
      description: "Immediate notifications for panic button activation or unusual movement patterns.",
      color: "from-red-500 to-red-600",
    },
    {
      icon: <Clock className="w-8 h-8" />,
      title: "Location History",
      description: "Access detailed movement history with timestamps and route visualization.",
      color: "from-purple-500 to-purple-600",
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: "Family Sharing",
      description: "Connect multiple family members and share location data securely.",
      color: "from-pink-500 to-pink-600",
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: "Long Battery Life",
      description: "Advanced power management ensures weeks of tracking on a single charge.",
      color: "from-yellow-500 to-yellow-600",
    },
  ];

  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900" id="features">
      <div className="container mx-auto px-4">
        <div
          className={`text-center mb-16 transform transition-all duration-1000 ${
            isInView ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        ...
        >
          ...
          <p className="text-xl text-white/70 max-w-3xl mx-auto">
            Our advanced GPS tracking technology combines precision, reliability, and ease of use to keep your loved ones safe.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <div
              key={index}
              className={`bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform ${
                isInView ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
  ...
  const steps = [
    {
      step: "01",
      title: "Setup Device",
      description: "Simply attach our compact GPS tracker to any item or give it to your loved one.",
      icon: <MapPin className="w-8 h-8" />,
    },
    {
      step: "02",
      title: "Configure Home",
      description: "Download our mobile Home and set up geofences, contacts, and preferences.",
      icon: <Shield className="w-8 h-8" />,
    },
    {
      step: "03",
      title: "Stay Connected",
      description: "Monitor real-time locations, receive alerts, and maintain peace of mind.",
      icon: <Heart className="w-8 h-8" />,
    },
  ];

  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900" id="how-it-works">
      <div className="container mx-auto px-4">
        <div
          className={`text-center mb-16 transform transition-all duration-1000 ${
            isInView ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        ...
        <div className="max-w-6xl mx-auto">
          {steps.map((step, index) => (
            <div
              key={index}
              className={`flex flex-col lg:flex-row items-center mb-16 last:mb-0 transform transition-all duration-1000 ${
                isInView ? "translate-x-0 opacity-100" : index % 2 === 0 ? "-translate-x-10 opacity-0" : "translate-x-10 opacity-0"
              }`}
              style={{ transitionDelay: `${index * 200}ms` }}
            >
              <div className={`flex-1 justify-between ${index % 2 === 0 ? "lg:order-1" : "lg:order-2"} mb-8 lg:mb-0`}>
                <div className="text-center lg:text-left">
                  <div className="inline-block bg-gradient-to-r from-blue-500 to-purple-600 text-white text-2xl font-bold px-6 py-3 rounded-full mb-6 shadow-lg">
                    {step.step}
                  </div>
                  <h3 className="text-3xl font-bold text-white mb-4">
                    {step.title}
                  </h3>
                  <p className="text-lg text-white/70 leading-relaxed max-w-md mx-auto lg:mx-0">
                    {step.description}
                  </p>
                </div>
              </div>

              <div className={`flex-1 ${index % 2 === 0 ? "lg:order-2" : "lg:order-1"} flex justify-center`}>
                <div className="w-64 h-64 bg-white/10 backdrop-blur-md border border-white/20 rounded-3xl flex items-center justify-center hover:scale-105 transition-transform duration-300">
                  <div className="w-24 h-24 bg-gradient-to-r from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-white shadow-lg">
                    {step.icon}
                  </div>
                </div>
              </div>
...
const TestimonialsSection = () => {
  ...
  const testimonials = [
    {
      name: "Aarti Sharma",
      role: "Mother of 2",
      content: "FenceTrack gave me the peace of mind I needed. I always know where my children are.",
      rating: 5,
      avatar: "👩‍💼",
    },
    {
      name: "Ravi Menon",
      role: "Caregiver",
      content: "Taking care of my elderly father became so much easier with instant alerts.",
      rating: 5,
      avatar: "👨‍💻",
    },
    {
      name: "Sneha Iyer",
      role: "Pet Owner",
      content: "My dog loves to explore, but now I never worry about losing him.",
      rating: 5,
      avatar: "👩‍🎓",
    },
  ];
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900" id="testimonials">
      <div className="container mx-auto px-4">
        <div
          className={`text-center mb-16 transform transition-all duration-1000 ${
            isInView ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        ...
        >
          ...
          <p className="text-xl text-white/70">Join thousands of families who trust FenceTrack</p>
        </div>
...
const PricingSection = () => {
  ...
  const plans = [
    {
      ...
      price: "$9.99",
      period: "/month",
      features: ["Real-time GPS tracking", "2 geofence zones", "Basic alerts", "Mobile Home access", "Email support"],
      popular: false,
      color: "from-blue-500 to-blue-600",
    },
    {
      ...
      price: "$19.99",
      period: "/month",
      features: ["Up to 5 devices", "Unlimited geofences", "Advanced alerts", "Location history", "Priority support", "Family sharing"],
      popular: true,
      color: "from-purple-500 to-purple-600",
    },
    {
      ...
      price: "$39.99",
      period: "/month",
      features: ["Unlimited devices", "Custom geofences", "API access", "Advanced analytics", "24/7 phone support", "Custom integrations"],
      popular: false,
      color: "from-green-500 to-green-600",
    },
  ];
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900" id="pricing">
      <div className="container mx-auto px-4">
        <div
          className={`text-center mb-16 transform transition-all duration-1000 ${
            isInView ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        ...
        >
          ...
          <p className="text-xl text-white/70">Flexible pricing options to fit your needs</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {plans.map((plan, index) => (
            <div
              key={index}
              className={`relative bg-white/10 backdrop-blur-md border rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 transform ${
                isInView ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
              } ${plan.popular ? "scale-105 border-purple-500/60 hover:bg-white/20" : "border-white/20 hover:bg-white/20"}`}
              style={{ transitionDelay: `${index * 100}ms` }}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-purple-500 to-purple-600 text-white px-6 py-2 rounded-full text-sm font-bold shadow-lg">
                  Most Popular
                </div>
              )}
...
const ContactSection = () => {
  ...
  return (
    <section ref={ref} className="py-20 bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900" id="contact">
      <div className="container mx-auto px-4">
        <div
          className={`text-center mb-16 transform transition-all duration-1000 ${
            isInView ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-white/70">support@fencetrack.com</p>
                </div>
              </div>
            </div>

            <div className="mt-12">
              <h4 className="font-bold text-white mb-4">Why Choose FenceTrack?</h4>
              <ul className="space-y-2">
                {[
                  "99.9% uptime guarantee",
                  "Military-grade security",
          ...
          <div
            className={`bg-white/10 backdrop-blur-md border border-white/20 p-8 rounded-2xl shadow-xl transform transition-all duration-1000 ${
              isInView ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"
            }`}
            style={{ transitionDelay: "200ms" }}
          >
            ...
            <form className="space-y-6">
              <div>
                <input
                  type="text"
                  placeholder="Your Name"
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-colors backdrop-blur-sm"
                />
              </div>
              ...
              <div>
                <textarea
                  placeholder="Your Message"
                  rows="4"
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-white/50 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition-colors backdrop-blur-sm resize-none"
                ></textarea>
              </div>

              <button
                type="submit"
                className="w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white py-4 rounded-xl font-bold text-lg hover:shadow-lg transition-all duration-300 cursor-pointer flex items-center justify-center space-x-2 transform hover:scale-105"
              >
                <span>Send Message</span>
                <ArrowRight className="w-5 h-5" />
              </button>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-white">FenceTrack</span>
            </div>
            <p className="text-white/60 text-sm">Real-time GPS tracking for peace of mind.</p>
          </div>
        ...
        <div className="border-t border-white/20 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm">
            &copy; 2024 FenceTrack. All rights reserved.
          </p>
...
const Home = () => {
  ...
  return (
    <div className="w-full min-h-screen overflow-hidden bg-gradient-to-br from-blue-900 via-purple-900 to-pink-900">
      <Navigation />
      <HeroSection />
      <FeaturesSection />
      <HowItWorksSection />
