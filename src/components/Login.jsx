      ...
      <section className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl h-[90dvh] w-full">
          ...
          <div className="space-y-3">
            ...
            <button className="w-full flex items-center justify-center px-3 py-3 border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 cursor-pointer">
