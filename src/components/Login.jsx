...
const LoginPage = () => {
  ...
  //   </div>
  // );
  <div className="h-dvh flex items-center justify-center relative overflow-hidden bg-gray-50 p-4 sm:p-6 md:p-8">
      {/* Animated Background */}
      <AnimatedBackground />
      ...
      <div className="relative z-10 w-full max-w-md">
        {/* Login Card */}
        <div className="bg-white/95 backdrop-blur-md rounded-3xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl h-[90dvh] w-full">
          ...
          {/* Divider */}
          {/* This divider is now visible on all screen sizes. */}
          <div className="my-6 hidden sm:flex items-center">
            <div className="flex-1 border-t border-gray-200"></div>
            <span className="px-4 text-sm text-gray-500 bg-white">or</span>
            <div className="flex-1 border-t border-gray-200"></div>
          </div>
          ...
          {/* Social Login Options */}
          <div className="space-y-3">
            {/* Reduced padding and font size for better mobile responsiveness */}
            <button className="w-full flex items-center justify-center px-3 py-2 border-2 border-gray-200 rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 cursor-pointer">
              <div className="w-5 h-5 mr-3"><FcGoogle size={22}/></div>
      ...
      {/* Demo Credentials Helper */}
      <div className="fixed bottom-4 left-4 bg-white/90 backdrop-blur-sm rounded-lg p-3 shadow-lg max-w-xs z-20">
        <p className="text-xs text-gray-600 mb-2">
          <strong>Demo Credentials:</strong>
        </p>
        <p className="text-xs text-gray-500">
